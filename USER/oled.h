...
#define OLED_SCK_0   GPIO_ResetBits(GPIOB, GPIO_Pin_13)
#define OLED_SCK_1   GPIO_SetBits(GPIOB, GPIO_Pin_13)
#define OLED_MOSI_0  GPIO_ResetBits(GPIOB, GPIO_Pin_15)
#define OLED_MOSI_1  GPIO_SetBits(GPIOB, GPIO_Pin_15)
